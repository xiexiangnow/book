                    ...
                    <div class="col-sm-12">
                        ...
                        <form action="" id="menu_form">
                            <table class="table table-model-2 table-hover">
                                ...
                                <tbody>
                                <?php if($type_list != null): if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            <td><?php echo ($v['id']); ?></td>
                                            <td><?php echo ($v['name']); ?></td>
                                            <td><?php echo subs($v['remark'],15);?></td>
                                            <td><a href="addIndex?id=<?php echo ($v['id']); ?>&nav=24" class="btn btn-secondary btn-sm btn-icon icon-left">
                                                   修改
                                               </a>

                                                <a href="javascript:void(0)" class="btn btn-danger btn-sm btn-icon icon-left" onclick="delete_typeInfo(<?php echo ($v['id']); ?>)">
                                                    删除
                                                </a>
                                            </td>

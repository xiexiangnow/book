    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">菜单 <?php if($menu_info['id'] != null): ?>修改<?php else: ?>添加<?php endif; ?></h3>
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal" id="addmenu_form" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="pid" >
                                ...
                                <?php if($menu_info != null): if($menu_info['parent_id'] != null): ?><option value="<?php echo ($menu_info['parent_id']); ?>"><?php echo ($menu_info['parent_name']); ?></option>
                                     <?php else: ?>
                                     <option value="0"> ≡≡≡根目录≡≡≡</option><?php endif; ?>

                                <?php else: ?>
                                <option value="0"> ≡≡≡根目录≡≡≡</option>
                                <!--暂定为最多三级-->
                                <?php if(is_array($menu_list)): $i = 0; $__LIST__ = $menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['id']); ?>"><?php echo str_repeat('&nbsp;',$v['level']*5);?> <?php if($v['level'] > 1): ?>∟<?php endif; echo ($v['title']); ?>
                                </option>


                                <?php if(is_array($v['child'])): $i = 0; $__LIST__ = $v['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>"><?php echo str_repeat('&nbsp;',$vo['level']*5);?> <?php if($vo['level'] > 1): ?>∟<?php endif; echo ($vo['title']); ?>
                                    </option>


                                <?php if(is_array($vo['child'])): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['id']); ?>"><?php echo str_repeat('&nbsp;',$val['level']*5);?> <?php if($val['level'] > 1): ?>∟<?php endif; echo ($val['title']); ?>
                                    </option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" class="form-control" value="<?php echo ($menu_info['title']); ?>" id="field-1" placeholder="请输入菜单名称">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="path" class="form-control" value="<?php echo ($menu_info['path']); ?>" id="" placeholder="请输入菜单路径，如：/menu/add">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="is_show"  value="1" <?php if($menu_info['is_show'] == 1): ?>checked="checked"<?php endif; ?>>
                                    显示
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="is_show"  value="0" <?php if($menu_info['is_show'] == 0): ?>checked="checked"<?php endif; ?>>
                                    隐藏
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="icon" value="linecons-star" <?php if($menu_info['icon'] == 'linecons-star' ): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-star"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-desktop" <?php if($menu_info['icon'] == 'linecons-desktop'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-desktop"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-note" <?php if($menu_info['icon'] == 'linecons-note'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-note"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-params" <?php if($menu_info['icon'] == 'linecons-params'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-params"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-database" <?php if($menu_info['icon'] == 'linecons-database'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-database"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-wallet" <?php if($menu_info['icon'] == 'linecons-wallet'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-wallet"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-pencil" <?php if($menu_info['icon'] == 'linecons-pencil'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-pencil"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-videocam" <?php if($menu_info['icon'] == 'linecons-videocam'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-videocam"></i>
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="icon" value="linecons-cog" <?php if($menu_info['icon'] == 'linecons-cog'): ?>checked="checked"<?php endif; ?>>
                                    <i class="linecons-cog"></i>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sort" class="form-control" value="<?php echo ($menu_info['sort']); ?>" id="field-2" placeholder="输入正整数，越大越靠前">
                        </div>
                    </div>

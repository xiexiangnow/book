...
{	
    ...
    if(ext == 1) {
		var img = '<a href="javascript:;" onclick="javascript:att_cancel(this,'+id+',\'upload\')" class="on"><div class="icon"></div><img src="/Public/Admin/img/ext/rar.png" width="80" imgid="'+id+'" path="'+src+'" title="'+filename+'"/></a>';
	}
    if(ext == 2){
		var img = '<a href="javascript:;" onclick="javascript:att_cancel(this,'+id+',\'upload\')" class="on"><div class="icon"></div><img src="/Public/Admin/img/ext/flv.png" width="80" imgid="'+id+'" path="'+src+'" title="'+filename+'"/></a>';
	}

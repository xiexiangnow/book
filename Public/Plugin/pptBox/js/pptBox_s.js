    ...
    */
    function PPTBox()
    {
        ...
        this._box = [];
        this._curIndex = 0;
        this.scroll_btn = true ;//翻页按钮
        
    }
    PPTBox.prototype =
    {
        _createMainBox : function (){
            var scroll = this.scroll_btn ? 'block' : 'none';
            ...
            html += "</div>";
            html += "<div id='"+this.uid+"_imagebox' class='imagebox' style='width:6px;height;top:-117px;right:-250px'></div>"; 			
            document.write(html);
        },
        _init : function (){
            var picstyle= "";
            ...
            for(var i=0;i<this._box.length;i++){
                ...
                imageHTML +="<div class='bitdiv "+((i==0)?"curimg":"defimg")+picstyle+" onclick = \""+eventstr+".clickPic("+i+")\"  onmouseover=\""+eventstr+".mouseoverPic("+i+")\">"+ (i+1) +"</div>" ;
            }
